...
export class ContractService {
  ...
  searchContractByNameCustomer(nameCustomer: string, startDate: string): Observable<any> {
    return this.http.get<any>(this.URL_CONTRACT + '/?customer.name_like=' + nameCustomer + '&startDate_gte=' + startDate);
  }
}
