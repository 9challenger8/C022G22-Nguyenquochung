...
export class FacilityAddComponent implements OnInit {
  ...
  getFormFacilityAdd() {
    this.facilityAddForm = new FormGroup({
      ...
      area: new FormControl('', [Validators.required, checkPositiveNumber]),
      cost: new FormControl('', [Validators.required, checkPositiveNumber]),
      ...
      poolArea: new FormControl('', [Validators.required, checkPositiveNumber]),
